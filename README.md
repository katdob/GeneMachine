![search-gear-icon](./frontend/src/assets/search-gear.svg)

### Welcome to GeneMachine!

GeneMachine is a project built for the technical interview section for my application for a Software Engineer position at [BVARI (Boston VA Research Institute)](https://www.bvari.org/). It is built using JavaScript, React, Python, Flask, MySQL, Docker, a CursorAI development environment, and agentic development with Anthropic Claude models (Opus). 
